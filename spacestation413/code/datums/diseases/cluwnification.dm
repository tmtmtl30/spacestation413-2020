...
/datum/disease/cluwnification/stage_act()
	...
	switch(stage)
		...
		if(3)
			...
			if(prob(2))
				to_chat(affected_mob, "<span class='danger'>You can feel your brain starting to break down.</span>")
		...
		if(4)
			...
			if(prob(10))
				to_chat(affected_mob, "<span class='danger'>Your brain feels like it's being ripped apart.</span>")
